...
;; This file is NOT part of GNU Emacs, although cl-indent.el is.
...
;; which is in Emacs proper. It does *not* require SLIME, but is
;; instead required by one of it's contribs, `slime-indentation'.
;;
